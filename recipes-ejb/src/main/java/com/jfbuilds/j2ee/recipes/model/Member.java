 ...
 * the License. package com.jfbuilds.j2ee.recipes.model; import
 * java.io.Serializable; import javax.persistence.Column; import
 ...
 * javax.persistence.UniqueConstraint; import
 ...
 * = "email")) public class Member implements Serializable { /** Default value
 * included to remove warning. Remove or modify at will. // private static final
 * long serialVersionUID = 1L;
 * @Id
 * @GeneratedValue private Long id;
 * @NotNull
 * @Size(min = 1, max = 25)
 * @Pattern(regexp = "[^0-9]*", message = "Must not contain numbers") private
 * String name;
 * @NotNull
 * @NotEmpty
 ...
 * @Column(name = "phone_number") private String phoneNumber; public Long
 * getId() { return id; } public void setId(Long id) { this.id = id; } public
 * String getName() { return name; } public void setName(String name) {
 * this.name = name; } public String getEmail() { return email; } public void
 * setEmail(String email) { this.email = email; } public String getPhoneNumber()
 * { return phoneNumber; } public void setPhoneNumber(String phoneNumber) {
